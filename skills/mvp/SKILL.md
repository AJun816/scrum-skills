...
tags: [business, mvp, scope, product]
requires_aider: false
dependencies: []
description: 【外部扩展】帮助按极简创业原则收敛 MVP 范围，优先手工、无代码和最小实现。
---
...
- 默认使用中文输出，必要时保留英文术语。
- 优先压缩范围，先交付价值，再讨论扩展能力。
- 如果用户的方案超出周末可交付范围，要主动要求继续缩小。
...
- [ ] Set up payments (Stripe or Square - 2.9% + 30 cents per transaction)
