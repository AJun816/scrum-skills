...
tags: [business, growth, profitability, operations]
requires_aider: false
dependencies: []
description: 【外部扩展】从盈利能力、可逆性和精力消耗三个维度评估扩张决策是否可持续。
---
...
- 默认使用中文输出，必要时保留英文术语。
- 所有建议都必须落到收入、成本、可逆性和精力消耗四个维度。
- 对花钱、招聘、融资等重大动作，要明确写出“默认活着还是默认死亡”判断。
...
- Example: At Gumroad, ~40 cents of variable cost per $1 earned
