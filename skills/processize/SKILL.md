...
tags: [business, process, manual-first, delivery]
requires_aider: false
dependencies: []
description: 【外部扩展】把产品设想改写成今天就能手工交付的流程，先流程化再产品化。
---
...
- 默认使用中文输出，必要时保留英文术语。
- 回答时优先产出一套可立即执行的手工流程，而不是先讨论软件架构。
- 如果用户直接跳到“我要开发什么”，要先把需求拉回到“今天如何手工交付价值”。
